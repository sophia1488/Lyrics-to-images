            ...
            with model.ema_scope():
                ...
                for n in trange(opt.n_iter, desc="Sampling"):
                    for prompts in tqdm(data, desc="data"):
                        ...
                        # samples_ddim: (n_samples, 4, 64, 64)
                        ...
                        # x_checked_image: (n_samples, 512, 512, 3) 

                        x_checked_image_torch = torch.from_numpy(
                            x_checked_image
                        ).permute(0, 3, 1, 2)

                        # x_checked_image_torch: (n_samples,3,512,512)
                        ...
                        if not opt.skip_save:
                            for x_sample in x_checked_image_torch:
                                ...
                                print(f'[txt2img] Save image to {outpath}/{base_count:05}.png') 
                                img.save(
